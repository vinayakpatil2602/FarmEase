	...
	private static Connection con;
	  public static Connection Connect()
	  {
		   try{
			   ...
			   con = DriverManager.getConnection("jdbc:mysql://localhost:3306/farming","root","");
		   }
		   catch(Exception e)
		   {
			   e.printStackTrace();
	  ...
	  public static int getCount(String table) throws Exception {
	    ...
	    public static List<String> getCategory() throws Exception {
	        ...
	        Connection con = Connect();
	        ResultSet rs = con.createStatement().executeQuery("select category_name from category");
	        while (rs.next()) {
