...
<div class="text-center mt-5">
    <h3>Online Fast Food Center</h3>
    <h4 class="border-bottom border-dark pb-2">Sweet Homes<br>
...
<%
    ...
    ResultSet rs = con.createStatement().executeQuery("SELECT * FROM order_details inner join product_db on product_db.prodid=order_details.prodid where order_id="
