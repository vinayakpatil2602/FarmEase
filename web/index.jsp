...
<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" style="width: 100%; height: 550px">
			<div class="carousel-item active">
				<img src="./Images/n1.jpg" alt="Los Angeles"
			...
			<div class="carousel-item">
				<img src="./Images/n4.jpg" alt="New York"
					style="width: 100%; height: 550px">
			</div>

			<div class="carousel-item">
				<img src="./Images/n5.jpg" alt="New York"
					style="width: 100%; height: 550px">
			</div>

			<div class="carousel-item">
				<img src="./Images/n6.jpg" alt="New York"
					style="width: 100%; height: 550px">
			</div>
           ...
           <%
            ...
            <div class="grid_1_of_4 images_1_of_4 overflow-hidden">
                <a href="cart1.jsp?prodid=<%= rs.getInt("prodid")%>&qty=1">
                    <img height="200" width="750" src="./Images/<%= rs.getString("photo")%>" alt="" /></a>
