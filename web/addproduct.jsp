...
<body>
	...
	<div class="bg-white vertical-nav" id="sidebar">
		...
		<div class="bg-light py-4 px-3 mb-1">
			<p class="font-weight-bold text-uppercase px-3 sidebar-title text-danger text-center">Fast Food Ordering System</p>
        ...
        <form method="post" enctype="multipart/form-data" action="../Upload">
            <div class="form-row">
                ...
                <div class="col-sm-6">
                 ...
                 Connection con1= DriverManager.getConnection("jdbc:mysql://localhost:3306/farming","root","");
