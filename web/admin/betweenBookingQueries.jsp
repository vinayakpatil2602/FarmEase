...
<div class="container card shadow m-5">
	  <div class="card-body">
		<h5 class="p-2" style="border-bottom: 2px solid orange">Between Date Report</h5><br>
            <div class="container-fluid">
			<form action="betweendate_BookreportDtls.jsp" method="post">
			  <div class="form-row">
						<div class="col-sm-8">
							<div class="form-group">
								<label>From Date</label> <input type="date" id="startdt"
								name="startdt" class="form-control" required>
								</div>
							</div>
