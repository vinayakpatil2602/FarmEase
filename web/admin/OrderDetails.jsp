...
<%
    ...
    ResultSet rs = con.createStatement().executeQuery("SELECT * FROM order_details inner join products on product_db.prodid=order_details.prodid where order_id=" + request.getParameter("oid"));
